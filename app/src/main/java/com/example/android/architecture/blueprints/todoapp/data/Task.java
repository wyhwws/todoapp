...
public final class Task {
     ...
     * @param description
     */
    public Task(@Nullable String title, @Nullable String description,String image) {
     ...
     */
    public Task(@Nullable String title, @Nullable String description,String image, String id) {
        mId = id;
        mTitle = title;
        mDescription = description;
        mImage = image;
     ...
     * @param completed
     */
    public Task(@Nullable String title, @Nullable String description,String image, boolean completed) {
        mId = UUID.randomUUID().toString();
        mTitle = title;
        mDescription = description;
        mImage = image;
     ...
     * @param completed
     */
    public Task(@Nullable String title, @Nullable String description,String image, String id, boolean completed) {
        mId = id;
        mTitle = title;
        mDescription = description;
        mImage = image;
    ...
    public static Task from(ContentValues values) {
        ...
        String image = values.getAsString(TasksPersistenceContract.TaskEntry.COLUMN_NAME_IMAGE);
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(mId, task.mId) &&
               ...
               Objects.equal(mDescription, task.mDescription)&&
                Objects.equal(mImage, task.mImage);
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(mId, mTitle, mDescription, mImage);
    }
