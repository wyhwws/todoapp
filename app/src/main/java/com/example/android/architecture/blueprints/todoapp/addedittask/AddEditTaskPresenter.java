...
public class AddEditTaskPresenter implements AddEditTaskContract.Presenter,
    ...
    @Override
    public void saveTask(String title, String description,String image) {
        if (isNewTask()) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (data != null && data.moveToLast()) {
            ...
            mAddTaskView.setImage(task.getImage());
        } else {
            // NO-OP, add mode.
        }
    }
    ...
    private void createTask(String title, String description,String image) {
    ...
    private void updateTask(String title, String description, String image) {
        if (isNewTask()) {
            throw new RuntimeException("updateTask() was called but task is new.");
        }
        mTasksRepository.saveTask(new Task(title, description,image, mTaskId));
