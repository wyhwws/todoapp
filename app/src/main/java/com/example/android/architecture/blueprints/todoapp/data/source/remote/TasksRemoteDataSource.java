...
public class TasksRemoteDataSource implements TasksDataSource {
    ...
    static {
        ...
        addTask("Build tower in Pisa","Build tower in Pisa", "Ground looks good, no foundation work required.");
        addTask("Build tower in Pisa","Finish bridge in Tacoma", "Found awesome girders at half the cost!");
    }
    ...
    private static void addTask(String title, String description, String image) {
