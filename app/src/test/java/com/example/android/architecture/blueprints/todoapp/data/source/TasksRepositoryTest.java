...
public class TasksRepositoryTest {
    ...
    private static List<Task> TASKS = Lists.newArrayList(new Task("Title1", "Description1","Image"),
            new Task("Title2", "Description2","Image2"));
    ...
    public void saveTask_savesTaskToServiceAPI() {
        ...
        Task newTask = new Task(TASK_TITLE, "Some Task Description", "Some Task Description");
    ...
    public void activateTask_activatesTaskToServiceAPIUpdatesCache() {
        ...
        Task newTask = new Task(TASK_TITLE, "Some Task Description", "Some Task Description", true);
        mTasksRepository.saveTask(newTask);
    ...
    public void deleteCompletedTasks_deleteCompletedTasksToServiceAPIUpdatesCache() {
        ...
        Task newTask = new Task(TASK_TITLE, "Some Task Description", "Some Task Description", true);
        mTasksRepository.saveTask(newTask);
        Task newTask2 = new Task(TASK_TITLE2, "Some Task Description", "Some Task Description");
        mTasksRepository.saveTask(newTask2);
        Task newTask3 = new Task(TASK_TITLE3, "Some Task Description", "Some Task Description", true);
